...
public class Detail_almasurat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_almasurat);
...
//        audioUrl = "http://www.all-birds.com/Sound/western%20bluebird.wav";
        try {
            if (inten.getStringExtra("audio") != null) {
            ...
            try {
                ...
                mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mediaPlayer) {
                        ...
                        mediaPlayer.stop();
                        mediaPlayer.reset();
                        mButtonPlay.setImageDrawable(getDrawable(R.drawable.ic_play_circle_filled_white_24dp));
                    }
                });
