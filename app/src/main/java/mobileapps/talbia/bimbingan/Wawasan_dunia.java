...
import mobileapps.talbia.Adapter.WawasanAdapter;
...
public class Wawasan_dunia extends AppCompatActivity implements WawasanAdapter.AdapterCallback {


    private static final String TAG = "data";
    ApiInterface mApiService;
    WawasanAdapter mRepoAdapter;

    @BindView(R.id.rvRepos)
    RecyclerView rvRepos;

    WawasanAdapter.AdapterCallback callback;

    List<Wawasan_m> repoList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<small>Wawasan Dunia</small"));
         ...
         */
        mRepoAdapter = new WawasanAdapter(this, repoList, this);
    ...
    private void ambildata() {
        ...
        mApiService.ambilwawasandunia()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<List<Wawasan_m>>() {
                    @Override
                    ...
                    @Override
                    public void onNext(List<Wawasan_m> responseRepos) {
                        /*
                        ...
                        for (int i = 0; i < responseRepos.size(); i++) {
                            Wawasan_m doamodel = responseRepos.get(i);
