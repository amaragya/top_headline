...
public class AlmasuratAdapter extends
        RecyclerView.Adapter<AlmasuratAdapter.ViewHolder> {

    private static final String TAG = AlmasuratAdapter.class.getSimpleName();

    private Context context;
    private List<Almasurat_m> list;
    ...
    private AlmasuratAdapter.ViewHolder holdernya;
    private int currentposition = 0;
    private int yanglagiplay = -1;

    public AlmasuratAdapter(Context context, List<Almasurat_m> list, AdapterCallback adapterCallback) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_doa,
                parent, false);
        return new AlmasuratAdapter.ViewHolder(view);
    }


    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    public void onBindViewHolder(final AlmasuratAdapter.ViewHolder holder, final int position) {
        Almasurat_m item = list.get(position);
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void konten_detail_handler(AlmasuratAdapter.ViewHolder holder, int position) {
        try {
...
//                        Toast.makeText(context, "toast", Toast.LENGTH_SHORT).show();
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void init_audio(final AlmasuratAdapter.ViewHolder holder, String audioUrl, int currentposition) {
