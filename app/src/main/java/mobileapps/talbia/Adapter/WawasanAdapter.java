...
public class WawasanAdapter extends
        RecyclerView.Adapter<WawasanAdapter.ViewHolder> {

    private static final String TAG = WawasanAdapter.class.getSimpleName();

    private Context context;
    private List<Wawasan_m> list;
    private AdapterCallback mAdapterCallback;

    public WawasanAdapter(Context context, List<Wawasan_m> list, AdapterCallback adapterCallback) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_informasi,
                parent, false);
        return new WawasanAdapter.ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(WawasanAdapter.ViewHolder holder, final int position) {
        Wawasan_m item = list.get(position);
