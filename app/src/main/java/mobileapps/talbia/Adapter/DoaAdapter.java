...
public class DoaAdapter extends
        RecyclerView.Adapter<DoaAdapter.ViewHolder> {

    private static final String TAG = DoaAdapter.class.getSimpleName();
    MediaPlayer mPlayer;
    private Button btn;
    ...
    private ArrayList<Integer> currentplaying = new ArrayList<>();
    ...
    private doa_ExpandableListAdapter.detailtestInterface listener;
    ...
    private DoaAdapter.ViewHolder holdernya;
    private int currentposition = 0;
    private int yanglagiplay = -1;


    public DoaAdapter(Context context, List<DataItem> list, AdapterCallback adapterCallback) {
    ...
    @Override
    public void onBindViewHolder(final DoaAdapter.ViewHolder holder, final int position) {
...
//        webview_konten.getSettings().setDisplayZoomControls(false);
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void konten_detail_handler(ViewHolder holder, int position) {
        try {
...
//                        Toast.makeText(context, "toast", Toast.LENGTH_SHORT).show();
    ...
    public void hidekonten() {
        holdernya.konten_wrapper.setVisibility(View.GONE);
    }
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void init_audio(final ViewHolder holder, String audioUrl, int currentposition) {
